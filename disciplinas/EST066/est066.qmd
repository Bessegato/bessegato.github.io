...
Live de 08/06/21, com uma discussão sobre transformação de variáveis aleatórias e algumas relações relevantes.
[Transformação de variáveis aleatórias](https://drive.google.com/file/d/1CsOz7bi5K6PGLVgZuqA-eGDc__qukPFP/view?usp=sharing){target="_blank" rel="noopener noreferrer"}.
...
Geração de números aleatórios de misturas de distribuições. [Estudo dirigido - Mistura de distribuições](../EST066/Estudo dirigido - Mistura de distribuições.html){target="_blank" rel="noopener noreferrer"}.
...
Notas de aula sobre estimação de integrais definidas pelo método Monte Carlo.
[Integração Monte Carlos](../EST066/01_Integracao_Monte_Carlo.html){target="_blank" rel="noopener noreferrer"}.

Estimação de integrais definidas pelo método de Monte Carlo. [Estudo dirigido - Integração Monte Carlo](../EST066/Estudo dirigido - Integração Monte Carlo.html){target="_blank" rel="noopener noreferrer"}.
...
Algumas propriedades probabilísticas e algoritmos envolvendo processos de Poisson e cadeias de Markov...
[Simulação de processos estocásticos](../EST066/05.1_processos.html){target="_blank" rel="noopener noreferrer"}.

Geração de realizações de processos de Poisson e cadeias de Markov.
[Estudo dirigido - Cadeias de Markov e processo de Poisson](../EST066/Estudo dirigido -Cadeias de Markov e processo de Poisson.html){target="_blank" rel="noopener noreferrer"}.

[Cadeias de Markov - Exemplos de aplicação na indústria](../EST066/Cadeias de Markov - Exemplos de aplicação na indústria.pdf){target="_blank" rel="noopener noreferrer"}.

Geração de realizações de processos de Poisson homogêneo e não homogêneo e simulação de eventos discretos.
[Processos estocásticos - Alguns problemas e implementações](../EST066/Processos estocásticos - Alguns problemas e implementações.pdf){target="_blank" rel="noopener noreferrer"}.

Simulações para estimação de parâmetros e intervalos de confiança.
[Bootstrap paramétrico](../EST066/06_distribuicao_amostral.html){target="_blank" rel="noopener noreferrer"}.
...
Uso de bootstrap não paramétrico para estimação de estatísticas amostrais e intervalos de confiança de parâmetros populacionais. [Estudo dirigido - Bootstrap](../EST066/Estudo dirigido - Bootstrap.pdf){target="_blank" rel="noopener noreferrer"}.
